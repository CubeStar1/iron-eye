...
import { Database, Search, ChevronDown, Code2, CheckCircle2, AlertCircle, Loader2, FileText, BarChart, Image as ImageIcon, Mail, MonitorPlay } from 'lucide-react';
...
import StagehandEmbed from '@/components/stagehand/stagehand-embed';
...
const TOOL_COMPONENTS: { [key: string]: React.FC<any> } = {
  ...
  stagehandRun: ({ result }) => <StagehandEmbed debugUrl={result.debugUrl} env={result.env} />,
};
